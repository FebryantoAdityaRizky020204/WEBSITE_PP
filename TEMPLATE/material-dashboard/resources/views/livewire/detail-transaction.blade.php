<div>
                            ...
                            <div class="card-body p-3 ps-4">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item border-0 text-sm mt-2 bg-secondary p-2 rounded g-1">
                                        <a href="{{ route('transactions') }}" class="badge badge-sm text-dark bg-gradient-light mt-0 mb-0 me-1 border-0">
                                            KEMBALI
                                        </a>
                                ...
                                <tbody>
                                    ...
                                    @if ($layanan)
                                        ...
                                        <tr class="mt-2 border-top border-dark">
                                            <td colspan="2" class="text-sm font-weight-normal align-middle">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-sm font-weight-normal align-middle border-bottom">
                                                    <button type="button" class="btn btn-sm btn-warning p-1 px-2 text-center btn-link" data-bs-toggle="modal"
                                                        data-bs-target="#editRincianLaundry" wire:click="showEditRincian({{ $rnc->id }})">
                                                        <i style="font-size: 15px" class="fa fa-pen-to-square" aria-hidden="true"></i>
                                                    </button>
                                                    
                                                    <button type="button" class="btn btn-sm btn-danger px-2 p-1 text-center btn-link" data-bs-toggle="modal"
                                                        data-bs-target="#hapusRincianLaundry" wire:click="showDeleteRincian({{ $rnc->id }})">
    ...
    <div wire:ignore.self class="modal fade" id="editRincianLaundry" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="editRincianLaundryLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form wire:submit="store" class=''>
                        <div class="col">
                            <div class="col mt-3 text-center">
                                <button type="button" class="btn btn-danger btn-sm" wire:click="deleteRincianLaundry">
                                    <i style="font-size: 15px" class="fas fa-trash" aria-hidden="true"></i>
                                    HAPUS
                                </button>
    
                                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal"
                                    data-bs-target="#hapusRincianLaundry" aria-label="Close" wire:click='resetInputs'>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="editTransaksi" class=''>
                        ...
                        <div class="form-group col-12">
                            ...
                            <input wire:model='nomor_telepon' type="string" class="form-control border border-2 p-2" id="nomor_telepon"
                                placeholder="Masukkan Jenis Laundry" autocomplete="off">
                            @error('nomor_telepon')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
    ...
    <div wire:ignore.self class="modal fade" id="cetakTransaksi" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="cetakTransaksiLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button 
                        type="button" class="btn btn-sm my-1 btn-dark" 
                        onclick="printToPDF()">
                        Cetak
                    </button>
                    <button 
                        type="button" class="btn btn-sm my-1 btn-secondary" 
                        data-bs-dismiss="modal" data-bs-target="#cetakTransaksi"
                                ...
                                <div class="card rounded-0" id="buktiTransaksiPrint">
                                    <div class="d-flex flex-row p-2 pb-0 justify-content-between">
                                        <div class="d-flex flex-column">
                                            ...
                                            <small>Kode Transaksi : <span class="text-bold">{{ $transaksi->id_transaksi }}</span></small>
                                        </div>
                                        <div class="d-flex flex-column">
                                    ...
                                    <div class="products p-2 py-0 border-bottom">
                                        <table class="table table-borderless text-sm">
                                            <tbody>
                                                <tr class="add">
                                                    <td class="text-dark">Layanan</td>
                                                    <td class="text-dark">Jumlah</td>
                                                    <td class="text-dark">Harga</td>
                                                    <td class="text-center text-dark">Total</td>
                                                </tr>
                                                @php
                                                $layanan = $transaksi->transaksiLayanan;
                                                @endphp
                                                @if ($layanan)
                                                    ...
                                                    <tr class="content">
                                                        ...
                                                        <td>{{ $ly->nilai_barang }} {{ $ly->layanan->satuan_barang }}</td>
                                        ...
                                        <table class="table table-borderless text-sm">
                                            <tbody>
                                                ...
                                                <tr class="text-dark text-bold">
                                                    ...
                                                    <td class="py-1 text-end">{{ $transaksi->pemasukan->status_pembayaran }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                ...
                                                <tr class="">
                                                    <td class="text-bold"> 
                                                        ...
                                                        @php
                                                            use Carbon\Carbon;
                                                            Carbon::setLocale('id');
                                                            $formattedTime = Carbon::now()->translatedFormat('d F Y H:i:s');
                                                        @endphp
                                                        <br> {{ $formattedTime }}
                                                    </td>
                                                </tr>
